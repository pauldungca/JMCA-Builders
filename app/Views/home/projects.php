        ...
        <?php foreach ($projects as $project): ?>
            <div class="project-card1"
                ...
                <div class="project-image1">
                    <img src="<?= base_url($project['image']) ?>" alt="<?= esc($project['title']) ?>">
                    <div class="project-overlay1">
                        <div class="project-status <?= strtolower(esc($project['status'])) ?>">
                ...
                <div class="project-info1">
                    ...
                    <p class="project-location">📍 <?= esc($project['location']) ?></p>
